...
namespace MandatoryASCHenrik.States
{
    ...
    //    public StatesTypes NextAction(InputType input)
    //    {
    //        switch (input)
    //        {
    //            case InputType.FORWARD: return StatesTypes.WEST;
    //            case InputType.LEFT: return StatesTypes.SOUTH;
    //            case InputType.RIGHT: return StatesTypes.NORTH;
    //        }

    //        return StatesTypes.NORTH;
    //    }
    //}
}
